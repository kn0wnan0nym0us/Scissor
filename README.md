# Scissor
Scissor is a simple tool which makes URLs as short as possible. Scissor offers and enables several features, including URL shortening, custom URLs, QR code generation, and basic analytics.
